...
// AssetService defines the subset of service methods used by handlers
type AssetService interface {
	CreateAsset(name, assetType string) (*model.Asset, error)
	ListAssets(params storage.QueryParams) (*storage.PaginatedResult, error)
	GetAssetByID(id string) (*model.Asset, error)
	UpdateAsset(id, name, assetType, status string) (*model.Asset, error)
