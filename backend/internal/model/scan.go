...
const (
	...
	ScanTypeIP   ScanType = "ip"   // IP geolocation & ASN lookup (passive)
...
func IsValidScanType(t ScanType) bool {
	...
	case ScanTypeAll, ScanTypeSubdomain, ScanTypeDNS, ScanTypeWHOIS, ScanTypeCertTrans,
		ScanTypePort, ScanTypeASN, ScanTypeIP, ScanTypeSSL:
		return true
	}
	return false
}
...
func (st ScanType) Description() string {
	...
	case ScanTypeIP:
		return "IP geolocation, ASN and reverse DNS lookup (passive)"
	case ScanTypePort:
