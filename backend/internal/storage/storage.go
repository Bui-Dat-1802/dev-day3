...
type ScanStorage interface {
	...
	// IP Result operations
	CreateIPResult(result *model.IPResult) error
	GetIPResultsByAsset(assetID string) ([]*model.IPResult, error)
	GetIPResultsByScan(scanJobID string) ([]*model.IPResult, error)
